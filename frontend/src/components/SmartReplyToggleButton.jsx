...
const SmartReplyToggleButton = ({ label = "Toggle", enabled, onToggle }) => {

  const handleToggle = () => {
    onToggle?.(!enabled); // preferred prop
    // onChange?.(newState); // optional compatibility
  };
  return (
...
export default SmartReplyToggleButton;
